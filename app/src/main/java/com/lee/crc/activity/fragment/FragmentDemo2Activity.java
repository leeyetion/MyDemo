...
import com.lee.crc.fragment.ListViewFragment;
import com.lee.crc.fragment.NewsFragment;


public class FragmentDemo2Activity extends Activity implements View.OnClickListener {
    private ImageView tab_bottom_viewgallery;
    private ImageView tab_bottom_email;
    private ImageView tab_bottom_account;

    private ListViewFragment viewgallery;
    private NewsFragment email;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        tab_bottom_viewgallery.setOnClickListener(FragmentDemo2Activity.this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            case R.id.tab_bottom_viewgallery:
                if (viewgallery == null)
                {
                    viewgallery = ListViewFragment.newInstance("viewgallery");
                }
            ...
            case R.id.tab_bottom_email:
                if (email == null)
                {
                    email = NewsFragment.newInstance("email");
                }
